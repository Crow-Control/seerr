...
export class AddMusicSupport1762648503371 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "blocklist" ADD "mbId" character varying`
    );
    ...
    await queryRunner.query(
      `ALTER TABLE "blocklist" ALTER COLUMN "tmdbId" DROP NOT NULL`
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "blocklist" ADD CONSTRAINT "UQ_30a2423945ffaeb135b518d074d" UNIQUE ("tmdbId", "mbId")`
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "blocklist" DROP CONSTRAINT "UQ_30a2423945ffaeb135b518d074d"`
    );
    await queryRunner.query(
      `ALTER TABLE "watchlist" DROP CONSTRAINT "UNIQUE_USER_DB"`
    );
    ...
    await queryRunner.query(
      `ALTER TABLE "blocklist" ALTER COLUMN "tmdbId" SET NOT NULL`
    );
    await queryRunner.query(
